...
class TopRatedPresenterTests: XCTestCase {
    var viewController: TopRatedViewControllerSpy!
    var presenter: TopRatedPresenter!

    override func setUp() {
        super.setUp()
        viewController = TopRatedViewControllerSpy()
